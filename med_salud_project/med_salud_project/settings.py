"""
Django settings for med_salud_project project.
...
SECRET_KEY = 'django-insecure-h&3wy652*4zvovo0lat!c9hpdh*ts0os40i59a1m^g+#-@tb=@'
...
ROOT_URLCONF = 'med_salud_project.urls'
...
WSGI_APPLICATION = 'med_salud_project.wsgi.application'
